...
function NetworkChart({ instance, onSelectDuration }) {
    ...
    useEffect(() => {
        ...
        LineSeries.stroke = am4core.color('blue')
        ...
        // var range = valueAxis.createSeriesRange(LineSeries)
        // range.value = 0
        // range.endValue = 1000
        ...
        BarSeries.stroke = am4core.color('blue')
        BarSeries.hide()
        ...
        // var range = valueAxis.createSeriesRange(BarSeries)
        // range.value = 0
        // range.endValue = 0
        // range.contents.stroke = am4core.color("#FF0000")
        // range.contents.fill = range.contents.stroke
            ...
            {showWizard && (
                <div className="chart-type-container">
                    <form className="chart-type-form">
                        <input type="radio" id="network-line" name="Line" value="line" onChange={onChange} checked={chartType === 'line'} />
                        <label className="chart-type-label" htmlFor="Line">Line</label>
                        <input type="radio" id="network-bar" name="Bar" value="bar" onChange={onChange} checked={chartType === 'bar'} />
